...
// @Accept json
// @Produce json
// @Param	client	body	models.Client	true	"Client to add"
...
func createClient(ctx *fiber.Ctx) (err error) {
	...
	ffjson.Unmarshal(ctx.Body(), &toCreateClient)
...
// @Produce json
// @Param	id	path	string	true	"Client ID"
// @Param	client	body	models.Client	true	"Desired client"
// @Success 200 {object} models.Client
// @Success 400 {object} ResultError
...
func replaceClient(ctx *fiber.Ctx) (err error) {
	...
	ffjson.Unmarshal(ctx.Body(), &desiredClient)
...
// @Produce json
// @Param	id	path	string	true	"Client ID"
// @Param	client	body	models.Client	true	"Client fields to update"
// @Success 200 {object} models.Client
